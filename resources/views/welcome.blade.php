    ...
    <div class="navbar">
        <div class="navbar-inner">
            <div class="container-fluid">
                ...
                <a class="brand" href="index.html"><span>Proposal Create</span></a>
            ...
            <div id="sidebar-left" class="span2">
                <div class="nav-collapse sidebar-nav">
                    <ul class="nav nav-tabs nav-stacked main-menu">
                        ...
                        <li><a href="{{URL::to('/all-customer')}}"><i class="icon-eye-open"></i><span class="hidden-tablet">All Customer</span></a></li>
                        <li><a href="{{URL::to('/add-customer')}}"><i class="icon-dashboard"></i><span class="hidden-tablet">Add Customer</span></a></ li>
